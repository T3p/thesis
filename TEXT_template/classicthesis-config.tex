...
% ****************************************************************
\newcommand{\myTitle}{Adaptive Batch Size for Policy Gradient Methods\xspace}
\newcommand{\myTitleIT}{Batch size adattiva per metodi policy gradient\xspace}
...
\newcommand{\expected}[3]{\mathop{\mathbf{E}}_{#1\sim\pi_{#2}}\left[#3\right]}

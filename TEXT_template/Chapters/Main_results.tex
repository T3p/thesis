...
\begin{figure}[H]
\includegraphics[width = 1.35\textwidth,right]{Images/upsilon.png}
\caption{Cost function $\Upsilon_\delta$ over batch size $N$. The optimal batch size $N^*$ is marked with a diamond. Batch sizes under the global minimum $N_0$ do not guarantee any performance improvement.}
\label{fig:0}
\end{figure}
